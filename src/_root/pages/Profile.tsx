...
import { FollowButton, HighlightStories, Loader } from "@/components/shared";
    ...
    <div className="flex w-full h-full">
      <div className="relative profile-container">
        ...
        <div className="flex flex-col items-start gap-6 w-full">
          ...
          <HighlightStories type="highlight" userId={currentUser.$id} />
        </div>
        ...
        {pathname.includes("liked-posts") || pathname.endsWith(`${id}`) && (
